     ...
     <div class="rr-company-grid">
       ${items.map(x=>`
         <article class="rr-card">
           ...
           <div class="rr-role-row rr-primary-row">
             <span class="rr-role-label primary-label">정</span>
             <div class="rr-role-copy"><small>업무 주관</small><p class="rr-role-text primary">${x.primary}</p></div>
           </div>
           <div class="rr-role-row rr-support-row">
             <span class="rr-role-label">부</span>
             <div class="rr-role-copy"><small>자료·인터뷰 대응</small><p class="rr-role-text">${x.support}</p></div>
           </div>
           ${x.coord?`
           <div class="rr-role-row coord">
             <span class="rr-role-label coord-label">총괄</span>
             <div class="rr-role-copy"><small>계열사 취합·조율</small><p class="rr-role-text">${x.coord}</p></div>
           </div>`:""}
         </article>`).join("")}
     </div>
